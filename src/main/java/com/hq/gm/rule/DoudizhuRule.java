package com.hq.gm.rule;

import java.util.ArrayList;
import java.util.List;
import java.util.TreeSet;

import com.hq.gm.entity.Poker;
import com.hq.gm.entity.Number;
...
public class DoudizhuRule {
   ...
   public static int checkpaiValue(int cardStyle,List<Poker> cards)
   {
	...
	public static List<Integer> checkLianDui2(List<Poker> pokers) {
		...
		System.out.println("checkLianDui2==========原始牌==============");
		for (int i = 0; i < cards.length; i++) {
			System.out.println("checkLianDui2" + cards[i]);
		}
		System.out.println("checkLianDui2===============================");
		if (cards.length > 0) {
			int current = cards[0];
			cardId1.add(cards[0]);
			...
			System.out.println("checkLianDui2==========连续的牌==============");
			for (int i = 0; i < cardId1.size(); i++) {
				System.out.println("checkLianDui2" + cardId1.get(i) + " ,");
			}
			System.out.println("checkLianDui2==============================");
			if (cardId1.size() >= 5) {
				for (int i = 0; i < cardId1.size(); i++) {
			...
			System.out.println("checkLianDui2==========散对子==============");
			for (int i = 0; i < card.size(); i++) {
				System.out.println("checkLianDui2" + card.get(i) + " ,");
			}
			System.out.println("checkLianDui2==============================");
			...
			System.out.println("checkLianDui2==========散对子====连续的牌==========");
			for (int i = 0; i < cardId1.size(); i++) {
				System.out.println("checkLianDui2" + cardId1.get(i) + " ,");
			}
			System.out.println("checkLianDui2==================================");
			...
			System.out.println("checkLianDui2==========连对==============");
			for (int i = 0; i < card2.size(); i++) {
				System.out.println("checkLianDui2" + card2.get(i) + " ,");
			}
			System.out.println("checkLianDui2============================");
		}
		return card2;
